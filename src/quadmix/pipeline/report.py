...
def _make_fig1(orig_dist, opt_dist, output_dir, num_domains=24):
    _setup_style()
...
def _experiment_table(exp_outputs_dir, data_path, num_domains=24, top_k=50,
...
def generate_report(
    ...
    domain_labels, token_counts, num_domains=24, num_criteria=5,
